...
- When doing calculations in a spreadsheet, it's easy to accidentally apply a slightly different formula to multiple adjacent cells
...
Data: Chihuahuan desert ecosystem
========================================================
...
- S. K. Morgan Ernest, Thomas J. Valone, and James H. Brown. 2009. Long-term monitoring and experimental manipulation of a Chihuahuan Desert ecosystem near Portal, Arizona, USA. Ecology 90:1708.
  ...
  - Data files: rodents, plants, ants, precipitation
- We will be using a modified tabular dataset of observations of small mammals
- It provides a real world example of life-history, population, and ecological data, with sufficient complexity to teach many aspects of data analysis and management, but some complexities have been removed for teaching purposes
...
<img src="figures/Figure1.png"></img>
</div>
***
- Variables: date collected, plot, species, sex and weight
...
- Discuss the steps you would need to take to clean up the data and put them all together in one spreadsheet

Common spreadsheet errors: using multiple tables
========================================================

<div class="midcenter" style="margin-left:10px; margin-top:50px;">
<img src="figures/Figure2.png"></img>
</div>
***
...
<div class="midcenter" style="margin-left:10px; margin-top:50px;">
<img src="figures/Figure3.png"></img>
</div>
***
...
<img src="figures/Figure4.png"></img>
</div>
***
<div class="midcenter" style="margin-right:100px; margin-top:50px;">
<img src="figures/Figure5.png"></img>
</div>
...
<img src="figures/Figure6.png"></img>
</div>
...
- Solution: 
  ...
  - do not include spaces, numbers, or special characters of any kind
...
Download the semi-cleaned data file: 
https://ndownloader.figshare.com/files/8015254
